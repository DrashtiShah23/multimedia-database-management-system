...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `permission_number` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `registereduser` (
  ...
  `admin_registereduser_registered_user_id` INT NULL DEFAULT NULL,
  `generaluser_user_id` INT NOT NULL,
  `has_logged_from_devices_device_id` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `organization` (
  ...
  `description` VARCHAR(45) NULL DEFAULT NULL,
  `organization_contact_num` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `promotions` (
  ...
  `description` VARCHAR(45) NULL DEFAULT NULL,
  `promotion_type` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `authors` (
  ...
  `author_description` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `music_artist` (
  `music_artist_id` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `music_album` (
  `music_album_id` TINYINT NOT NULL,
  `tile` VARCHAR(255) NOT NULL,
  `year_released` INT NOT NULL,
  `artist_id` TINYINT NULL DEFAULT NULL,
  PRIMARY KEY (`music_album_id`),
  INDEX `fk_album_artist_idx` (`artist_id` ASC) VISIBLE,
  CONSTRAINT `fk_album_artist`
    FOREIGN KEY (`artist_id`)
    REFERENCES `music_artist` (`music_artist_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `music_genre` (
  `music_genre_id` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `music_tracks` (
  ...
  `Multimedia_Content_cdn_id` INT NOT NULL,
  `music_artist` TINYINT NULL DEFAULT NULL,
  `music_album` TINYINT NULL DEFAULT NULL,
  `music_genre` TINYINT NULL DEFAULT NULL,
  `music_track_rating` INT NOT NULL,
  `year` INT NULL,
  PRIMARY KEY (`music_id`),
  INDEX `fk_music_Multimedia_Content1_idx` (`Multimedia_Content_cdn_id` ASC) VISIBLE,
  INDEX `fk_music_artist_idx` (`music_artist` ASC) VISIBLE,
  INDEX `fk_music_genre_idx` (`music_genre` ASC) VISIBLE,
  INDEX `fk_music_album_idx` (`music_album` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_music_artist`
    FOREIGN KEY (`music_artist`)
    REFERENCES `music_artist` (`music_artist_id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_music_genre`
    FOREIGN KEY (`music_genre`)
    REFERENCES `music_genre` (`music_genre_id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `basic_can_stream_music` (
  ...
  CONSTRAINT `fk_Basic_has_music_music1`
    ...
    REFERENCES `music_tracks` (`music_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `manifest` (
  ...
  `manifesturl` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `album_rating` (
  ...
  `year` INT NULL,
  PRIMARY KEY (`mid`),
  CONSTRAINT `FK_musicalbums_ratings`
    FOREIGN KEY (`mid`)
    REFERENCES `music_album` (`music_album_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `audio_book_rating`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `audio_book_rating` (
  `ab_id` INT NOT NULL,
  `stars` INT NULL,
  PRIMARY KEY (`ab_id`),
  CONSTRAINT `FK_audiobook_rating`
    FOREIGN KEY (`ab_id`)
    REFERENCES `audio_books` (`audio_book_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
